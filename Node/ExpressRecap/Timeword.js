...
const timeToWords = (timeString) => {
    ...
    // console.log(`Time after split: ${inputHours}-${inputMinutes}`)
    //edge cases
    ...
    //finding which hour, reducing from 24 military time to 0-12
    for(hourNum in hours){
        // console.log(num)
        //we run through the keys, and match!
        ...
        if(parseInt(inputHours) < 12){
            if(parseInt(inputHours) == parseInt(hourNum)){
                output += hours[hourNum];
                // console.log(`hour output: ${output}`);
            }
        }
        if(parseInt(inputHours) > 12) {
    ...
    //short and simple, match to large object, 
    //could be improved later to match and combine to subsets 
...
// console.log(timeToWords('11:01'));
// console.log(timeToWords('13:11'));
// console.log(timeToWords('01:23'));
// console.log(timeToWords('04:35'));
// console.log(timeToWords('12:01'));
// console.log(timeToWords('00:11'));
// console.log(timeToWords('00:04'));
